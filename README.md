...
- U-Net is a good dense-prediction baseline, but it is not necessarily the best architecture if the next goal is multi-object perception, transformer-based fusion, or real-time robot deployment.
